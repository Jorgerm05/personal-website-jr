...
const HeroSection = () => {
  return (
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
           <h1 className="text-blue-600 mb-4 text-4xl sm:text-5xl lg:text-8xl lg:leading-normal font-extrabold">
  <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-blue-600">Hello, I&apos;m{" "}</span>
          ...
          &ldquo;It is better to fail in originality than to
           succeed in imitation.&ldquo;
            — Herman Melville
          </p>
          <div>
          <Link
              href="/resumes/Jorge_s_Resume.pdf"
              download="Jorge_s_Resume.pdf"
